...
declare type VNodeArgsTransformerFn = NonNullable<Parameters<typeof transformVNodeArgs>[0]>;
...
declare type VNodeTransformerInputComponentType = VNodeTransformerInputType & ConcreteComponent;
export declare type VTUVNodeTypeTransformer = (inputType: VNodeTransformerInputComponentType, instance: InstanceArgsType) => VNodeTransformerInputComponentType;
