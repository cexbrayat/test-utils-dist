...
import { Teleport, Transition, BaseTransition, TransitionGroup, defineComponent, h, nextTick, setDevtoolsHook, shallowReactive, reactive, isRef, createApp, transformVNodeArgs, computed } from 'vue';
...
var createVNodeTransformer = function (_a) {
    ...
    return function (args, instance) {
        var originalType = args[0], restVNodeArgs = args.slice(1);
