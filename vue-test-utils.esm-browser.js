...
function isCompatEnabled$1(key) {
  var _a, _b;
  return (_b =
    (_a = Vue.compatUtils) === null || _a === void 0
      ? void 0
...
function matches(node, rawSelector) {
  ...
  if (!isComponent$1(nodeType)) return false;
...
function parseElement(context, ancestors) {
  ...
  // 2.x inline-template compat
  {
    const inlineTemplateProp = element.props.find(
      (p) =>
        p.type === 6 /* NodeTypes.ATTRIBUTE */ && p.name === "inline-template"
    );
    if (
      inlineTemplateProp &&
      checkCompatEnabled(
...
function processSlot(source, Vue$1) {
  ...
  var createRenderFunction = new Function(
    "Vue",
    "'use strict';\n".concat(code)
  );
  ...
  if (global.config) {
    for (var _i = 0, _a = Object.entries(global.config); _i < _a.length; _i++) {
      var _b = _a[_i],
        k = _b[0],
        v = _b[1];
      app.config[k] = isObject$2(app.config[k])
