...
var VueTestUtils = (function (exports, Vue, compilerDom) {
  ...
  function mergeStubs(target, source) {
    if (source.stubs) {
      if (Array.isArray(source.stubs)) {
        ...
        for (
          var _i = 0, _a = Object.entries(source.stubs);
          _i < _a.length;
          _i++
        ) {
          var _b = _a[_i],
  ...
  function mergeAppConfig(configGlobalConfig, mountGlobalConfig) {
    return __assign(
      __assign(__assign({}, configGlobalConfig), mountGlobalConfig),
      {
        globalProperties: __assign(
          __assign(
            {},
            configGlobalConfig === null || configGlobalConfig === void 0
              ? void 0
              : configGlobalConfig.globalProperties
          ),
          mountGlobalConfig === null || mountGlobalConfig === void 0
            ? void 0
  ...
  function mergeGlobalProperties(mountGlobal) {
    ...
    var stubs = {};
    var configGlobal =
      (_a = config === null || config === void 0 ? void 0 : config.global) !==
        null && _a !== void 0
        ? _a
        : {};
    mergeStubs(stubs, configGlobal);
    mergeStubs(stubs, mountGlobal);
    var renderStubDefaultSlot =
      (_c =
        (_b = mountGlobal.renderStubDefaultSlot) !== null && _b !== void 0
          ? _b
          : config === null || config === void 0
          ? void 0
          : config.renderStubDefaultSlot) !== null && _c !== void 0
        ? _c
        : configGlobal === null || configGlobal === void 0
        ? void 0
        : configGlobal.renderStubDefaultSlot;
    return {
      mixins: __spreadArray(
        __spreadArray([], configGlobal.mixins || [], true),
        mountGlobal.mixins || [],
        true
      ),
      plugins: __spreadArray(
        __spreadArray([], configGlobal.plugins || [], true),
        mountGlobal.plugins || [],
        true
      ),
      stubs: stubs,
      components: __assign(
        __assign({}, configGlobal.components),
        mountGlobal.components
      ),
      provide: __assign(
        __assign({}, configGlobal.provide),
        mountGlobal.provide
      ),
      mocks: __assign(__assign({}, configGlobal.mocks), mountGlobal.mocks),
      config: mergeAppConfig(configGlobal.config, mountGlobal.config),
      directives: __assign(
        __assign({}, configGlobal.directives),
        mountGlobal.directives
      ),
  ...
  function getEventProperties(eventParams) {
    ...
    var eventProperties = __assign(
      __assign(__assign(__assign({}, systemModifiersMeta), options), {
  ...
  function isCompatEnabled(key) {
    var _a, _b;
    return (_b =
      (_a = Vue__namespace.compatUtils) === null || _a === void 0
        ? void 0
        : _a.isCompatEnabled(key)) !== null && _b !== void 0
      ? _b
      : false;
  }
  ...
  var getComponentNameInSetup = function (instance, type) {
    return Object.keys(
      ...
      var _a;
      return (
        ((_a = Object.getOwnPropertyDescriptor(instance.setupState, key)) ===
          null || _a === void 0
          ? void 0
          : _a.value) === type
      );
  ...
  var registerStub = function (_a) {
    var source = _a.source,
      stub = _a.stub,
      originalStub = _a.originalStub;
    stubsMap.set(stub, { source: source, originalStub: originalStub });
  };
  var getOriginalVNodeTypeFromStub = function (type) {
    var _a;
    return (_a = stubsMap.get(type)) === null || _a === void 0
      ? void 0
      : _a.source;
  };
  var getOriginalStubFromSpecializedStub = function (type) {
    var _a;
    return (_a = stubsMap.get(type)) === null || _a === void 0
      ? void 0
      : _a.originalStub;
  ...
  var shouldNotStub = function (type) {
    return doNotStubComponents.has(type);
  };
  ...
  function createStubComponentsTransformer(_a) {
    ...
    return function componentsTransformer(type, instance) {
      ...
      if (
        (type === Vue.Transition || type === Vue.BaseTransition) &&
        "transition" in stubs
      ) {
      ...
      if (stub === true || shallow) {
        ...
        var newStub =
          (_c =
            (_b = (_a = config.plugins).createStubs) === null || _b === void 0
              ? void 0
              : _b.call(_a, {
                  name: stubName,
                  component: type,
  ...
  function matches(node, rawSelector) {
    ...
    if (typeof selector === "string") {
      return (_b =
        (_a = node.el) === null || _a === void 0 ? void 0 : _a.matches) ===
        null || _b === void 0
        ? void 0
        : _b.call(_a, selector);
    }
  ...
  function aggregateChildren(nodes, children) {
    if (children && Array.isArray(children)) {
      var reversedNodes = __spreadArray([], children, true)
        .reverse()
        .filter(nodesAsObject);
  ...
  function find(root, selector) {
    ...
    if (typeof selector === "string") {
      ...
      matchingVNodes = matchingVNodes.filter(function (vnode) {
        var _a;
        return (
          ((_a = vnode.component.parent) === null || _a === void 0
            ? void 0
            : _a.vnode.el) !== vnode.el
        );
      });
    }
      ...
      get: function (obj, prop) {
        switch (prop) {
          ...
          default:
            throw new Error(
              "Cannot call "
                .concat(String(prop), " on an empty ")
                .concat(wrapperType, ".")
            );
        }
      },
  ...
  function requireBeautifier$2() {
    ...
    function reserved_array(token, words) {
      return (
        token && token.type === TOKEN.RESERVED && in_array(token.text, words)
      );
    }
  ...
  var BaseWrapper = /** @class */ (function () {
    function BaseWrapper(element) {
      ...
      this.isDisabled = function () {
        ...
        var elementCanBeDisabled =
          isElement(_this.element) &&
    ...
    BaseWrapper.prototype.findAllDOMElements = function (selector) {
      ...
      var result = __spreadArray(
        [],
        elementRootNodes.filter(function (node) {
    ...
    BaseWrapper.prototype.html = function () {
      return this.getRootNodes()
        .map(function (node) {
          return pretty(stringifyNode(node));
        })
        .join("\n");
    };
    ...
    BaseWrapper.prototype.get = function (selector) {
      ...
      throw new Error(
        "Unable to get ".concat(selector, " within: ").concat(this.html())
      );
    };
      ...
      while (
        ((_a =
          component === null || component === void 0
            ? void 0
            : component.parent) === null || _a === void 0
          ? void 0
          : _a.vnode.el) === this.element
      ) {
  ...
  var recordEvent = function (vm, event, args) {
    ...
    var wrapperVm = vm;
    while (
      typeof (wrapperVm === null || wrapperVm === void 0
        ? void 0
        : wrapperVm.type) === "function"
    )
  ...
  var VueWrapper = /** @class */ (function (_super) {
    ...
    function VueWrapper(app, vm, setProps) {
      var _this =
        _super.call(this, vm === null || vm === void 0 ? void 0 : vm.$el) ||
        this;
  ...
  function processSlot(source, Vue) {
    ...
    // transition
    var code = compilerDom.compile(
      "<transition>".concat(template, "</transition>"),
      {
        mode: "function",
  ...
  var createVNodeTransformer = function (_a) {
    ...
    return function (args, instance) {
      var originalType = args[0],
        restVNodeArgs = args.slice(1);
      if (!isComponent(originalType)) {
        return __spreadArray([originalType], restVNodeArgs, true);
      }
      var cachedTransformation = transformationCache.get(originalType);
      if (cachedTransformation) {
        return __spreadArray([cachedTransformation], restVNodeArgs, true);
      }
      ...
      return __spreadArray([transformedType], restVNodeArgs, true);
    };
  };
  ...
  function mount(inputComponent, options) {
    ...
    var component;
    var instanceOptions = getInstanceOptions(
        ...
        __assign(
          {
            compatConfig: {
              ...
              COMPONENT_FUNCTIONAL: isLegacyFunctionalComponent(
                originalComponent
              )
                ? "suppress-warning"
                : false,
    ...
    if (options === null || options === void 0 ? void 0 : options.attachTo) {
      ...
      if (typeof options.attachTo === "string") {
        ...
        if (!to) {
          throw new Error(
            "Unable to find the element matching the selector ".concat(
              options.attachTo,
              " given as the `attachTo` option"
            )
          );
        }
      } else {
    ...
    var slots =
      (options === null || options === void 0 ? void 0 : options.slots) &&
    ...
    if (options === null || options === void 0 ? void 0 : options.data) {
      ...
      if (isObjectComponent(originalComponent)) {
        ...
        objectComponent.data = function (vm) {
          return __assign(
            __assign({}, originalDataFn_1.call(vm, vm)),
            providedData_1
          );
        };
      } else {
      ...
      __assign(
        __assign(
          __assign(
            __assign(
              {},
              options === null || options === void 0 ? void 0 : options.attrs
            ),
            options === null || options === void 0 ? void 0 : options.propsData
          ),
    ...
    var global = mergeGlobalProperties(
      options === null || options === void 0 ? void 0 : options.global
    );
    if (isObjectComponent(component)) {
      component.components = __assign(
        __assign({}, component.components),
        global.components
      );
    }
    ...
    if (global === null || global === void 0 ? void 0 : global.mocks) {
      var mixin = {
        beforeCreate: function () {
          for (
            var _i = 0, _a = Object.entries(global.mocks);
            _i < _a.length;
            _i++
          ) {
            var _b = _a[_i],
    ...
    if (global.config) {
      for (
        var _i = 0, _a = Object.entries(global.config);
        _i < _a.length;
        _i++
      ) {
        var _b = _a[_i],
    ...
    if (global.plugins) {
      for (var _c = 0, _d = global.plugins; _c < _d.length; _c++) {
        ...
        if (Array.isArray(plugin)) {
          app.use.apply(
            app,
            __spreadArray([plugin[0]], plugin.slice(1), false)
          );
          continue;
        }
        app.use(plugin);
    ...
    if (global.components) {
      for (
        var _g = 0, _h = Object.keys(global.components);
        _g < _h.length;
        _g++
      ) {
        var key = _h[_g];
    ...
    if (global.directives) {
      for (
        var _j = 0, _k = Object.keys(global.directives);
        _j < _k.length;
        _j++
      ) {
        var key = _k[_j];
    ...
    if (global.provide) {
      for (
        var _l = 0, _m = Reflect.ownKeys(global.provide);
        _l < _m.length;
        _l++
      ) {
        var key = _m[_l];
      ...
      createVNodeTransformer({
        transformers: [
          createStubComponentsTransformer({
            stubs: global.stubs,
            shallow:
              options === null || options === void 0 ? void 0 : options.shallow,
      ...
      var children =
        (_b =
          ...
          : _b.call(_a, {
              ...
              isActive: Vue.computed(function () {
                return false;
              }),
              isExactActive: Vue.computed(function () {
                return false;
              }),
              navigate: function () {
