...
declare type PublicProps = VNodeProps &
  AllowedComponentProps &
  ComponentCustomProps;
declare type ComponentMountingOptions<T> = T extends DefineComponent<
...
>
  ? MountingOptions<
    ...
    > &
      Record<string, any>
  : MountingOptions<any>;
export declare function mount<V extends {}>(
  originalComponent: {
    new (...args: any[]): V;
    __vccOpts: any;
  },
...
export declare function mount<V extends {}, P>(
  originalComponent: {
    new (...args: any[]): V;
    __vccOpts: any;
...
export declare function mount<Props extends {}, E extends EmitsOptions = {}>(
...
>(
  ...
  >
>;
export declare function mount<T extends DefineComponent<any, any, any, any>>(
  component: T,
